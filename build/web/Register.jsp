        ...
        <div class="container">
            <div class="intro-text">
                ...
                <div class="col-md-6" >
                    ...
                    <input style="background-color: black" id="id" type="text" name="id" required />
                </div>       
                    <div class="col-md-6" >
                    <div class="form-title">first name</div>
                    <input style="background-color: black" id="firstname" type="text" name="firstname" required />
                </div>       
                     <div class="col-md-6">
                    <div class="form-title">last name</div>
                    <input style="background-color: black" id="lastname" type="text" name="lastname" required />
                </div>
                     <div class="col-md-6">
                    ...
                    <input style="background-color: black" id="lastname" type="text" name="lastname" required />
                     ...
                     <div class="col-md-6">
                    <div class="form-title">re-password</div>
                    <input style="background-color: black" id="re-password" type="text" name="re-password" required />
                </div>
                     <div class="col-md-6">
                    <div class="form-title">email</div>
                    <input style="background-color: black" id="email" type="text" name="email" required />
                </div>
                     <div class="col-md-6">
                    <div class="form-title">address</div>
                    <input style="background-color: black" id="address" type="text" name="address" required />
                </div>
                     <div class="col-md-6">
                    <div class="form-title">phone</div>
                    <input style="background-color: black" id="phone" type="text" name=phone" required />
                </div>
